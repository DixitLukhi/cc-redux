...
function SinglePaymentRequestDetails() {
    ...
    const getUserCards = async () => {
        try {
            const response = await axios.get(`${baseurl}/api/cards/cards-list?card_id=${request_id}`, { headers: header });
        ...
        <div className="wrapper min-h-full">
            <div className="flex items-center justify-between pb-11">
                <div className="flex items-center cursor-pointer">
                    ...
                    <h3 className="text-yankeesBlue leading-8 pl-3 sm:pl-7">Payment Request</h3>
                </div>
            ...
            {loading ?
                ...
                <div className="">
                    <div className="bg-lightWhite rounded-xl p-5 md:py-6 md:px-12 mb-7">
                        ...
                        <div className="md:hidden flex justify-start sm:justify-end sm:mt-3 md:mt-0">
                            <div className="inline-block text-xl font-semibold text-[#ED4D37] bg-[#f3e7e7] rounded-lg px-3 md:px-5 2xl:px-6 py-2 md:py-4 2xl:py-5">Request</div>
                        </div>
                    </div>
...
export default SinglePaymentRequestDetails