                        ...
                        <div className="w-full">
                            ...
                            <div className="w-full flex flex-wrap md:flex-nowrap md:space-x-6 md:mb-7">
                                ...
                                <div className='w-full md:w-1/2 mb-3 md:mb-0'>
                                    ...
                                    <input type="date" name="card_exp_date" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-xl" placeholder='Enter due date' required onChange={(e) => setInputValue("due_date", e.target.value)} defaultValue={formik.values?.due_date || ""} />
                            ...
                            <div className="w-full flex flex-wrap md:flex-nowrap md:space-x-6 md:mb-7">
                                ...
                                <div className='w-full md:w-1/2 mb-3 md:mb-0'>
                                    ...
                                    <input type="number" name="due_amount" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-xl" placeholder='Enter due amount' required onChange={(e) => setInputValue("due_amount", e.target.value)} defaultValue={formik.values?.due_amount || ""} />
