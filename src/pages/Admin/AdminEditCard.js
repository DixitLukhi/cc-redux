...
import { adminCardById } from '../../redux/services/paymentServices/adminServices';
import { useDispatch } from 'react-redux';
import { editAdminCard, getAdminCardByID } from './adminSlice';
...
export default function AdminEditCard() {
    ...
    const clickNextHandler = async (values) => {
        ...
        try {
            const response = await dispatch(editAdminCard(requestObj)).unwrap();
    ...
    useEffect(() => {
        ...
        //     frontside_card_photo: data.frontside_card_photo,
                ...
                <div className="pt-5 md:pt-10">
                    <form onSubmit={formik.handleSubmit}>
                        <div className="w-full">
                            ...
                            <div className="w-full flex flex-wrap md:flex-nowrap md:space-x-6 md:mb-7">
                                <div className='w-full md:w-1/2 mb-3 md:mb-0'>
                                    <label htmlFor="frontside_card_photo" className="input-title2">Card photo upload*</label>
                                    <label className='input_box2 flex items-center border-dashed justify-center' htmlFor='card-photo'>
                                        ...
                                        <span className="text-[#94A3B8] font-normal text-xl pl-4"> {formik.values.frontside_card_photo && formik.values.frontside_card_photo !== "" ?
                                    ...
                                    {/* <input type="file" name="frontside_card_photo" id='card-photo' className="input_box2 placeholder:text-[#94A3B8] placeholder:text-base hidden" placeholder='Card photo upload' required onChange={(e) => setInputValue("frontside_card_photo", e.currentTarget.files[0])} defaultValue={formik.values?.frontside_frontside_card_photo || ""} /> */}
