...
function CommissionUnpaidHistory() {
    const [commissionUnpaidHistory, setCommissionUnpaidHistory] = useState();
    ...
    const columns = [
...

        {
            header: 'Status', field: (row) => {
                return <div className="text-xs font-semibold text-[#F6A351] bg-[#FFF0E0] rounded-lg px-3 py-2">Unpaid</div>
            }
        },
        {
    ...
    return (
        <div className="wrapper min-h-full">
            <div className="flex justify-end xl:hidden p-3 2xl:px-5 cursor-pointer">
                <div className='flex items-center space-x-3 bg-darkGreen rounded-md px-3 py-2'>
                    ...
                    <span className="text-[#fff] text-base 2xl:text-xl font-semibold">
                        Create Commission Invoice
                    </span>
                </div>
            </div>
            <div className="relative flex flex-wrap items-center- justify-start mb-8 md:mb-[50px]">
                <div className="w-full md:w-1/2 xl:w-1/4 p-3 2xl:px-5">
                    <div className="bg-[#F3F4F6] border border-transparent py-7 px-7 2xl::px-11 rounded-xl h-full">
                ...
                <div className="w-full md:w-1/2 xl:w-1/4 p-3 2xl:px-5">
                    <div className="bg-[#F3F4F6] border border-transparent py-7 px-7 2xl::px-11 rounded-xl h-full">
                        <h2 className="text-darkGreen mb-3">₹ 25,000</h2>
                        <span className="text-[#64748B] text-base 2xl:text-xl font-semibold">
                            Commission Pending
                        </span>
                    </div>
                </div>
                <div className="hidden xl:inline-block w-full md:w-1/2 xl:w-1/4 p-3 2xl:px-5 cursor-pointer">
                    <div className='flex items-center space-x-3 bg-darkGreen rounded-md px-3 py-2'>
                        <svg className='mr-3' width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.6 1.6C8.6 1.26863 8.33137 1 8 1C7.66863 1 7.4 1.26863 7.4 1.6L7.4 7.4H1.6C1.26863 7.4 1 7.66863 1 8C1 8.33137 1.26863 8.6 1.6 8.6H7.4V14.4C7.4 14.7314 7.66863 15 8 15C8.33137 15 8.6 14.7314 8.6 14.4V8.6H14.4C14.7314 8.6 15 8.33137 15 8C15 7.66863 14.7314 7.4 14.4 7.4H8.6L8.6 1.6Z" fill="white" stroke="white" strokeLinecap="round" />
                        </svg>
            ...
            <DataTable value={commissionUnpaidHistory} columnResizeMode={"expand"} resizableColumns={true} scrollable={true} paginator rows={5}>
                {columns.map((col, i) => (
...
export default CommissionUnpaidHistory