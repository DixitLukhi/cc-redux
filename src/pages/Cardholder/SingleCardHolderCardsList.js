                ...
                <div className="wrapper min-h-full">
                    <div className="sm:flex flex-wrap items-center justify-between">
                        <div className="flex items-center">
                            <svg onClick={() => navigate("../singlecardholderdetail")} width="24" height="16" viewBox="0 0 24 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h3 className="max-w-[270px] sm:max-w-[300px] text-yankeesBlue leading-8 pl-4 smx:pl-7 truncate">{userData.first_name} {userData.last_name}</h3>
                        </div>
                        <div className="flex justify-end items-center space-x-4">
                            <div onClick={() => navigate("../../payment")} className="flex items-center rounded-lg border-2 border-lightGray cursor-pointer px-3 sm:px-5 py-1.5 sm:py-2.5">
                            ...
                            <div onClick={() => setListView(!listView)} className="flex items-center rounded-lg border-2 border-lightGray cursor-pointer px-3 sm:px-5 py-2 sm:py-3">
                                {/* card view Icon */}
