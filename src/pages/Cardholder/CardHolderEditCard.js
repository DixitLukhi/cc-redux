                        ...
                        <div className="w-full">
                            <div className="w-full flex flex-wrap md:flex-nowrap items-center md:space-x-6 md:mb-7">
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    ...
                                    <input type="text" name="card_network" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm md:placeholder:text-xl" placeholder='Visa' required onChange={(e) => setInputValue("card_network", e.target.value)} defaultValue={formik.values?.card_network || ""} />
                            ...
                            <div className="w-full flex flex-wrap md:flex-nowrap md:space-x-6 md:mb-7">
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    ...
                                    <input type="text" name="card_bank_name" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm md:placeholder:text-xl" placeholder='Enter bank name' required onChange={(e) => setInputValue("card_bank_name", e.target.value)} defaultValue={formik.values?.card_bank_name || ""} />
                                ...
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    ...
                                    <input maxLength={12} type="text" name="card_number" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm md:placeholder:text-xl" placeholder='Enter card number' required onChange={(e) => setInputValue("card_number", e.target.value)} defaultValue={formik.values?.card_number || ""} />
                            ...
                            <div className="w-full flex flex-wrap md:flex-nowrap md:space-x-6 md:mb-7">
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    ...
                                    <input type="text" name="card_holder_name" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm md:placeholder:text-xl" placeholder='Enter card holder name' required onChange={(e) => setInputValue("card_holder_name", e.target.value)} defaultValue={formik.values?.card_holder_name || ""} />
                                ...
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    ...
                                    <input type="date" name="card_exp_date" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm md:placeholder:text-xl" placeholder='Enter card expiry date' required onChange={(e) => setInputValue("card_exp_date", e.target.value)} defaultValue={formik.values?.card_exp_date || ""} />
                            ...
                            <div className="w-full flex flex-wrap md:flex-nowrap md:space-x-6 md:mb-7">
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    ...
                                    <label className='input_box2 flex justify-start items-center border-dashed md:justify-center' htmlFor='card-photo'>
                                        ...
                                        <span className="text-[#94A3B8] font-normal text-sm md:text-xl pl-4">Card photo upload</span>

                                    </label>
                                    <input type="text" name="card_photo" id='card-photo' className="input_box2 placeholder:text-[#94A3B8] placeholder:text-base hidden" placeholder='Card photo upload' required onChange={(e) => setInputValue("card_photo", e.target.value)} defaultValue={formik.values?.card_photo || ""} />
                                    <small className="text-red-500 text-xs">{formik.errors.card_photo}</small>
                                </div>
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    <label htmlFor="due_date" className="input-title2 relative">Due Date *</label>
                                    <input type="date" name="card_exp_date" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm md:placeholder:text-xl" placeholder='Enter due date' required onChange={(e) => setInputValue("due_date", e.target.value)} defaultValue={formik.values?.due_date || ""} />
                            ...
                            <div className="w-full flex flex-wrap md:flex-nowrap md:space-x-6 md:mb-7">
                                ...
                                <div className='w-full md:w-1/2 mb-4 md:mb-0'>
                                    ...
                                    <input type="number" name="due_amount" className="input_box2 placeholder:text-[#94A3B8] placeholder:text-sm md:placeholder:text-xl" placeholder='Enter due amount' required onChange={(e) => setInputValue("due_amount", e.target.value)} defaultValue={formik.values?.due_amount || ""} />
