...
import { getAllCards } from './cardslice';
                ...
                <div className="wrapper min-h-full">
                    <div className="xsm:flex items-center justify-end">
                        <div className="flex items-center justify-end xsm:justify-between space-x-4 mt-3 xsm:mt-0">
                            <div onClick={() => navigate("../../payment")} className="flex items-center rounded-lg border-2 border-lightGray cursor-pointer px-5 py-2.5">
                                ...
                                <>
                                    ...
                                    <div className="">
                                        <DataTable
                                            ...
                                            header={headerf}
                                            onSelectionChange={(col) => { localStorage.setItem("card_id", col.value.card_id); navigate("../cards/carddetails") }} paginator
                                            rows={5}
                                        >
                                            {columns.map((col, i) => (
